...
namespace hastakayit
{
    public partial class Form1 : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-PLOAH0A\\SQLEXPRESS;Initial Catalog=hastanem;Integrated Security=True");
